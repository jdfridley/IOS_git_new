...
hist(dat$other.protN,xlim=c(-.5,1.5),breaks=50)
  #mode is about zero, so have some problems rectifying these protein measures
...
bar.cols = c(bar.cols[1:3],"lightgreen","burlywood4","cornflowerblue")
...
barht = rbind(FNr.m,FNl.m,FNb.m,FNo.m,FNc.m)
tot3 = colSums(barht)
FN.miss = Ntot.m - tot3 
...
text(rep(b1,each=6),as.numeric(midpoints)*1000,perc.lab,col="white",cex=.8,lwd=2)
...
mtext("Cell wall",side=4,las=1,at=midpoints[5,3]*1000)
mtext("Residual",side=4,las=1,at=midpoints[6,3]*1000)
