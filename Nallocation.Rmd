...
par(mfrow=c(1,2),mar=c(4,4,1,1))
plot(dat$Narea[dat$woody==0],dat$Vcmax[dat$woody==0],col=c(c1,c2,c3)[as.numeric(dat$Region)][dat$woody==0],pch=19,xlab="Leaf N (g m-2)",ylab="Vcmax")
legend(legend=c("ENA","France","Japan"),bty="n",cex=.8,text.col=c("darkgreen","blue","red2"),"topleft")
plot(dat$Rub.perc[dat$woody==0]*dat$Narea[dat$woody==0],dat$Vcmax[dat$woody==0],col=c(c1,c2,c3)[as.numeric(dat$Region)][dat$woody==0],pch=19,xlab="Rubisco N (g m-2)",ylab="Vcmax")
  #but it doesn't; suggests a problem with Rubisco?
