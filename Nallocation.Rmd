...
- Need defensive chemistry data to calculate Nd. Lamine will share soon.
...
#some outliers, but not unresonable (20-17% middle half quantile)
...
hist(dat$Nc[dat$Nc<1]) #seems much too high
summary(dat$Nc)
...
boxplot(Water.prot.mg.cm2~woody+Year+Region,data=dat,las=3,xlab="",col=c("darkgreen","brown"),cex.axis=.7,xaxt="n")
legend(legend=c("Herbs","Woody"),text.col=c("darkgreen","brown"),"topright",bty="n")
boxplot(SDS.prot.mg.cm2~woody+Year+Region,data=dat,las=3,xlab="",col=c("darkgreen","brown"),cex.axis=.7,ylim=c(0,2))
